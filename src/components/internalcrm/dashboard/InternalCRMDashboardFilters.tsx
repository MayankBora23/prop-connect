...
import type { DashboardDateFilter } from '@/hooks/useInternalCRMDashboard';
...
interface InternalCRMDashboardFiltersProps {
...
export function InternalCRMDashboardFilters({
  dateFilter,
  onFilterChange,
  customFrom,
  customTo,
  onCustomRange,
}: InternalCRMDashboardFiltersProps) {
  return (
